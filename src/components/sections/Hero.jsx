    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 pointer-events-none px-6">
        <div className="pointer-events-auto flex flex-col items-center text-center">
          ...
          {/* Eyebrow pill */}
          <div className="mb-6 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm text-slate-300 backdrop-blur-sm">
            <span/>
            Specialized In FLow Edits
          </div>

          {/* Headline — the main scale jump */}
          <h1 className="max-w-4xl bg-linear-to-r from-white via-teal-300 to-violet-400 bg-clip-text text-transparent font-extrabold leading-[1.05] tracking-tight text-6xl md:text-8xl">
            SOUL EDITS
          </h1>
