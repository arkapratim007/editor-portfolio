...
function About() {
  return (
    <section id='about' className='min-h-screen w-full bg-black bg-[radial-gradient(#3b82f6_1px,transparent_1px)] bg-size-[40px_40px] font-sans text-white flex items-center justify-center p-4 md:p-6'>
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 items-center justify-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-4">
              ...
              storytelling, & immersive visuals. Whether it's crafting adrenaline-pumping  montages, or engaging content for creators,
              I thrive on creating top notch content. 
            </p>
